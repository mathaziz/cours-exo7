...
On rajoute une force de frottement $\vec F =  - h \frac{\dd x(t)}{\dd t}$
...
$$-kx(t)- h \frac{\dd x(t)}{\dd t} = m\frac{\dd^2 x(t)}{\dd t^2}$$

En divisant par la masse $m$, en regroupant tous les termes du même côté et en posant $f = \frac{h}{m}$, on obtient l'équation différentielle :
$$y'' + f y' + \frac{k}{m} y = 0$$
